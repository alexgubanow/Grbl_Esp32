...
#define MACHINE_NAME            "grbl32bp4a"
...
// the corresponding pin undefined.
 ...
 #define SPINDLE_OUTPUT_PIN         GPIO_NUM_5   // labeled SpinPWM
 #define SPINDLE_ENABLE_PIN      GPIO_NUM_32  // labeled SpinEnbl
 #define COOLANT_MIST_PIN        GPIO_NUM_23  // labeled Mist
 #define COOLANT_FLOOD_PIN       GPIO_NUM_9  // labeled Flood
...
// or some other unsafe condition exists.
 #define CONTROL_SAFETY_DOOR_PIN GPIO_NUM_34  // labeled Door,  needs external pullup
...
// defining a second pin to control the other motor on the axis.  For example:
 ...
 #define Y2_STEP_PIN             GPIO_NUM_21  /* labeled Z */
 #define Y2_DIRECTION_PIN        GPIO_NUM_22  /* labeled Z */
